        ...
        <header class="w3-display-container w3-content w3-hide-medium" style="max-width:2000px">
            ...
            <div class="w3-display-middle" style="width:90%; height: 90%">
                ...
                <ul class="w3-navbar w3-black">
                    ...
                    <li><a href="javascript:void(0)" class="tablink" onclick="openLink(event, 'consult');"><i class="fa fa-hospital-o w3-margin-right"></i>Live Consulation</a></li>
                    ...
                    <li><a href="javascript:void(0)" class="tablink" onclick="openLink(event, 'reports');"><i class="fa fa-bar-chart w3-margin-right"></i>Reports</a></li>
                </ul>
                ...
                <div id="reports" class="w3-container w3-white w3-padding-16 myLink">
                    <div id="wrapper">
