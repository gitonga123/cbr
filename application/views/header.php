    ...
    <html lang="en">
        <head>
            <meta charset="utf-8">
                ...
                <script type="text/javascript" src='assets/admin/js/jquery-2.1.1.js'></script>
                ...
                <script type="text/javascript" src="assets/admin/js/plugins/chartJs/Chart.min.js"></script>
