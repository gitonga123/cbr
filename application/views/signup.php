...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="assets/admin/css/plugins/datapicker/datepicker3.css" rel="stylesheet"></link>
    ...
    <body>
        ...
        <div class="w3-top">
            <ul class="w3-navbar w3-white w3-wide w3-padding-8 w3-card-2">
                <li>
                    <a href="#home" class="w3-margin-right w3-hover-blue"><img src="assets/images/logo11.png" height="30px;" /></i>CBR DIAGNOSIS</b></a>
                </li>
        ...
        <header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
            <img class="w3-image" src="assets/images/home_page.jpg" alt="Architecture" width="1500" height="700" />
            <div class="row" style="margin-top: -30%; margin-bottom: 10%">
                ...
                <div class="col-lg-5" style="color:white">
                    ...
                    <div style="margin-left: -5%" >
                        <form class="form-horizontal" method="post" action="/cbr/login/user_validate" id="login-form">
        ...
        <div class="w3-content w3-padding" style="max-width:1564px">
            ...
            <div class="w3-container w3-padding-32" id="signup">
                ...
                <form  id="form" action="signup/upload_file" class="wizard-big" method="post" enctype="multipart/form-data">
                    <h1>Account</h1>
        ...
        <script type="text/javascript" src="assets/admin/js/demo/chartjs-demo.js"></script>
        <script type="text/javascript">

            $(document).ready(function () {

                $('#login-from').on('submit', function (form) {
                    form.preventDefault();
                    $.post('login/user_validate', $('#login-form').serialize(), function (data) {
